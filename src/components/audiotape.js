...
// 结束录音
    ...
    render() {
        ...
        const recoderText = this.props.msg.recoderText;
        return (
            <div className="audiotape-wrap">
                ...
                {this.props ? <p className="audiotape-detail audiotape-change">{area} {room} {bed}</p> : null}
                {/* <p className="audiotape-detail audiotape-change">{area}  {room}  {bed}病床</p> */}
                <p className="audiotape-prompt audiotape-change">{recoderText}</p>
