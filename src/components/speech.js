            ...
            return <div className="speech-card" key={index}>
                <div className="speech-card-msg">
                    ...
                    <span className="speech-delete">
                        <img src={require("../images/delete.png")} alt="" onClick={this.deleteBar.bind(this, 'speech', item.id)} />
                    </span>
                </div>
                ...
                <div className="speech-bar-tell" onClick={this.showWords.bind(this, item.context, item.id)}>{item.context}</div>
            </div>
